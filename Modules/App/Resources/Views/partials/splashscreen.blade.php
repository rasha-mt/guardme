<div class="ui page inverted dimmer" id="splashscreen" style="z-index: 100000">
    <div class="content uk-position-relative">
        ...
        <div class="white uk-text-center uk-position-bottom-center p-4 uk-position-large fg-site-blue"
